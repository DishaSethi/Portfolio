...
import { RiGithubFill, RiLink, RiLinkedinFill, RiTwitchFill, RiTwitterFill } from "react-icons/ri";
...
const contacts = () => {
 ...
 >
    ...
    <motion.a 
    href={`mailto:4{CONTACT_CONTENT.email}`}
    
    className="text-2xl md:text-3xl font-medium font-medium mt-8"
    initial="hidden"
    whileInView="visible"
    custom={0.8}
    variants={textVariants}>
